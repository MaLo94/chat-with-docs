...
import base64
import os
from vectorizer import EmbeddingsManager  # Import the EmbeddingsManager class
from agent import ChatbotManager     # Import the ChatbotManager class
...
# Chatbot Page
    ...
    st.title("🤖 Chatbot Interface (Llama 3.2:1b RAG)")
    st.markdown("---")
...
# Contact Page
    ...
    st.title("📬 Contact me")
    st.markdown("""
    This is a template based project to make RAG-Based system and checking different approaches plus frameworks to evaluate many aspects in this field

    - **Email:** [developer@example.com](mailto:mahdilotfi.j444@gmail.com) ✉️
    - **GitHub:** [Contribute on GitHub](https://github.com/MaLo94/chat-with-docs) 🛠️

    If you'd like to request a feature or report a bug, please open a pull request on my GitHub repository. Your contributions are highly appreciated!
    """)

# Footer
st.markdown("---")
st.markdown("© Do your Best")